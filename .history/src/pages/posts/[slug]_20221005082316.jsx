  ...
  return (
    <Layout>
      ...
      <div className="block lg:flex pt-0 md:pt-8">
        <div className="prose prose-lg md:prose-xl prose-lime prose-w-md prose-img:rounded-xl prose-figcaption:text-center hover:prose-a:text-trees5-500 hover:prose-img:shadow-lg max-w-none pl-4 pr-4 sm:pr-12 lg:border-r mx-auto">
          <HeaderPost>
            <h1
